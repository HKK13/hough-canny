...
def canny_edge_detection(image, kernel_size, sigma, low_threshold=31, high_threshold=91):
    ...
    return hysteresis_threshold(suppressed_gradient, low_threshold, high_threshold)
